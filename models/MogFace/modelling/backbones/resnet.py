# ******************************************************
# Author       : liuyang
# Last modified: 2020-01-13 20:42
...
class ResNet(nn.Module):
    ...
    def load_weights(self, base_file):
        ...
        if ext == '.pkl' or '.pth':
            ...
            #not_pretrained_model = {k : v for k, v in pretrained_model.items() if k not  in model_dict}
...
if __name__ == '__main__':
    ...
    #model.load_weights('../..//pretrain_weights/resnet50-19c8e357.pth')
    model = resnet18()
